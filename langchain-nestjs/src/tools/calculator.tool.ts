...
import * as math from 'mathjs'; // <-- ИМПОРТИРУЕМ MATHJS

export class CalculatorTool extends Tool {
  name = 'calculator'; 
  description = 'A tool for performing basic arithmetic calculations. Input must be a single, valid mathematical expression (e.g., "5 + 3 * 2").';
